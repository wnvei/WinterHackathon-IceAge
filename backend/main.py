...
def get_questions(subject_name: str):
    ...
    # 3. Validated Questions (Raw AI output)
    
    paths = [
        SUBJECTS_DIR / subject_name / "outputs" / "questions_with_answers.json",
        SUBJECTS_DIR / subject_name / "outputs" / "final_questions.json",
        SUBJECTS_DIR / subject_name / "processed" / "validated_questions.json"
    ]
